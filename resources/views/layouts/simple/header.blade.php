    ...
    <div class="nav-right col-8 pull-right right-header p-0">
      ...
      <!-- notificaciones -->
        <li class="onhover-dropdown">
          <div class="notification-box"><i data-feather="bell"> </i><span class="badge rounded-pill badge-secondary">{{$alert_product}}
          </span></div>
          <ul class="notification-dropdown onhover-show-div">
            ...
            <li>
               <a href="/stock"><p><i class="fa fa-circle-o me-3 font-primary"> </i>Tienes {{$alert_product}} productos por debajo stock minimo<!-- <span class="pull-right">10 min.</span> --></p></a>
            </li>
            <li></li>
          </ul>
        </li>
