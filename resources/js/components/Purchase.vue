              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  <tr v-for="item in purchases.data" :key="item.id">
                    ...
                    <td>
                      <div class="btn-group">
                        <button @click="editPurchaseData(item), btn_update_active=1, modal_title='Editar Compra'" class="btn btn-primary btn-xs" type="button" title=""  data-bs-toggle="modal"  data-bs-target="#exampleModal">
