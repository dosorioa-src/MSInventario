               ...
               <table class="table table-sm">
                  ...
                  <tbody>
                     <tr v-for="item in categories" :key="item.id">
                        ...
                        <td>
                          <button @click="editCategorieData(item), btn_update_active=1, modal_title='Editar Categoría'" class="btn btn-primary btn-xs" type="button" title=""  data-bs-toggle="modal"  data-bs-target="#exampleModal">
                          ...
                          <button  @click="deleteCategorie(item)" class="btn btn-secondary btn-xs" type="button" title="">
                              <svg width="15" height="15" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0)">
