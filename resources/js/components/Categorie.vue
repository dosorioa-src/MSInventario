      ...
      <div class="col-sm-12">
         <div class="card">
            <div class="card-header">
               <button type="button" data-bs-toggle="modal" data-original-title="test" data-bs-target="#exampleModal" data-bs-original-title="" title="" class="btn btn-primary">Nueva Categoría</button> 
               <div id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade" style="display: none;">
                  <div role="document" class="modal-dialog">
                     <div class="modal-content">
                        <div class="modal-header">
                           <h5 id="exampleModalLabel" class="modal-title">Agrega una categoría</h5>
                           <button type="button" data-bs-dismiss="modal" aria-label="Close" data-bs-original-title="" title="" class="btn-close"></button>
                        </div>
                        <div class="modal-body">
                           <form>
                              <div class="row g-3">
                                 <div class="col-md-6"><label for="validationDefault01" class="form-label">Nombres y Apellido</label> <input id="validationDefault01" type="text" placeholder="Nombres y Apellido" required="required" data-bs-original-title="" title="" class="form-control" style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%;" autocomplete="off"></div>
                                 <div class="col-md-6"><label for="validationDefault02" class="form-label">Email</label> <input id="validationDefault02" type="text" placeholder="Email" required="required" data-bs-original-title="" title="" class="form-control" style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%;" autocomplete="off"></div>
                              </div>
                              <div class="row g-3">
                                 <div class="col-md-6">
                                    <label for="validationDefault03" class="form-label">Contraseña</label> <input id="validationDefault03" type="password" required="required" placeholder="*********" data-bs-original-title="" title="" class="form-control" style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%;" autocomplete="off"> <!---->
                                 </div>
                                 <div class="col-md-6">
                                    <label for="validationDefault04" class="form-label">Rol de Usuario</label> 
                                    <select id="validationDefault04" required="required" class="form-select">
                                       <option selected="selected" disabled="disabled" value="">Rol</option>
                              ...
                              <div class="row g-3">
                                 <div class="col-md-6">
                                    <label for="validationDefault04" class="form-label">Tipo de ID</label> 
                                    <select id="validationDefault04" required="required" class="form-select">
                                       <option selected="selected" disabled="disabled" value="">Tipo</option>
                                       <option value="1">RUN</option>
                                    </select>
                                 </div>
                                 <div class="col-md-6 mb-6"><label for="validationDefault05" class="form-label">Numero de ID</label> <input id="validationDefault05" type="text" placeholder="42455155" required="required" data-bs-original-title="" title="" class="form-control" style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%;" autocomplete="off"></div>
                              </div>
                              <div class="row g-3">
                                 <div class="col-md-6"><label for="validationDefault03" class="form-label">Teléfono</label> <input id="validationDefault03" type="text" placeholder="Teléfono" required="required" data-bs-original-title="" title="" class="form-control" style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%;" autocomplete="off"></div>
                              </div>
                              <div class="col-md-6">
                              ...
                              <div class="modal-footer">
                                 <button type="submit" data-bs-original-title="" title="" class="btn btn-primary">Guardar</button> <!---->
                              </div>
                           </form>
                        </div>
                     </div>
               ...
               <table class="table table-sm">
                  <thead>
                     <tr>
                        ...
                        <th scope="col">Valorado (precio | costo)</th>
                  ...
                  <tbody>
                     <tr v-for="item in categories" :key="item.id">
                        ...
                        <th><img :src="item.image" width="50"></th>
                        <td>{{item.name}}</td>
                        <td>david@g.com</td>
                        <td>254</td>
                        <td>1585</td>
                        ...
                        <td>
                           <button data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-original-title="btn btn-success btn-sm" type="button" title="" data-original-title="btn btn-warning btn-sm" class="btn btn-success btn-xs">
                           ...
                           <button type="button" title="" data-bs-original-title="btn btn-secondary btn-sm" data-original-title="btn btn-warning btn-sm" class="btn btn-secondary btn-xs">
                              <svg width="15" height="15" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 <g clip-path="url(#clip0)">
