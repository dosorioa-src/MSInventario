            ...
            <table class="table table-sm">
              ...
              <tbody>
                <tr v-for="item in companies" :key="item.id" >
                  ...
                  <td>
                    <button @click="editProviderData(item)"  v-on="btn_update_active == 1" class="btn btn-primary btn-xs" type="button" title=""  data-bs-toggle="modal"  data-bs-target="#exampleModal">
