          ...
          <div class="card-header" style="padding: 20px 40px !important">
            ...
            <div class="row">
              ...
              <div class="col-md-8 col-sm-12 align-self-end text-end">
                <button
                  @click="btn_update_active=0, modal_title='Nueva Marca'"
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <tr style="vertical-align:middle" v-for="item in brands" :key="item.id" >
                      ...
                      <td>
                        <div class="btn-group">
                          <button @click="editBrandData(item), btn_update_active=1, modal_title='Editar Marca'" class="btn btn-primary btn-xs" type="button" title=""  data-bs-toggle="modal"  data-bs-target="#exampleModal">
